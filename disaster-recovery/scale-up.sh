...
if [[ "$database" == "foidb" ]]; then
    ...
    echo "Found deployments. Starting to scale all deployments with label disaster-recovery=d7abee to 1."
    ...
    echo "All deployments with label disaster-recovery=d7abee have been scaled to one"
